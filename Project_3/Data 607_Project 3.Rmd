...
mongoFile <- gridfs(db = "PROJECT TITLE", url = "mongodb+srv://USER URL", prefix = "fs",options = ssl_options(weak_cert_validation = TRUE))
...
tweet <- read.csv("tweet.csv",fileEncoding = "ISO-8859-1",header=TRUE, stringsAsFactors = FALSE)
